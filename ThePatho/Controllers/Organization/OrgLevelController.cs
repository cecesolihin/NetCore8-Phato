...
namespace ThePatho.Controllers
{
    ...
    public class OrgLevelController : ControllerBase
    {
        ...
        public async Task<IActionResult> ExportOrgLevel([FromQuery] string type, CancellationToken cancellationToken)
        {
            var exportResponse = await mediator.Send(new ExportOrgLevelCommand { Type = type }, cancellationToken);
