...
namespace ThePatho.Controllers
{
    ...
    public class CostCenterController : ControllerBase
    {
        ...
        public async Task<IActionResult> ExportCostCenter([FromQuery] string type, CancellationToken cancellationToken)
        {
            var exportResponse = await mediator.Send(new ExportCostCenterCommand { Type = type }, cancellationToken);
