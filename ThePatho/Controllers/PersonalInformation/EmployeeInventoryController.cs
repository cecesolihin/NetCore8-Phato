...
namespace ThePatho.Controllers
{
    ...
    public class EmployeeInventoryController : ControllerBase
    {
        ...
        public async Task<IActionResult> ExportEmployeeInventory([FromQuery] string type, CancellationToken cancellationToken)
        {
            var exportResponse = await mediator.Send(new ExportEmployeeInventoryCommand { Type = type }, cancellationToken);
