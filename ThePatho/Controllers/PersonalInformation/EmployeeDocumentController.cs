...
namespace ThePatho.Controllers
{
    ...
    public class EmployeeDocumentController : ControllerBase
    {
        ...
        public async Task<IActionResult> ExportEmployeeDocument([FromQuery] string type, CancellationToken cancellationToken)
        {
            var exportResponse = await mediator.Send(new ExportEmployeeDocumentCommand { Type = type }, cancellationToken);
