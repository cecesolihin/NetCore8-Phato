...
namespace ThePatho.Controllers
{
    ...
    public class EmployeeAddressController : ControllerBase
    {
        ...
        public async Task<IActionResult> ExportEmployeeAddress([FromQuery] string type, CancellationToken cancellationToken)
        {
            var exportResponse = await mediator.Send(new ExportEmployeeAddressCommand { Type = type }, cancellationToken);
