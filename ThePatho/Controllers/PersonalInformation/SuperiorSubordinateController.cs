...
namespace ThePatho.Controllers
{
    ...
    public class SuperiorSubordinateController : ControllerBase
    {
        ...
        public async Task<IActionResult> ExportSuperiorSubordinate([FromQuery] string type, CancellationToken cancellationToken)
        {
            var exportResponse = await mediator.Send(new ExportSuperiorSubordinateCommand { Type = type }, cancellationToken);
