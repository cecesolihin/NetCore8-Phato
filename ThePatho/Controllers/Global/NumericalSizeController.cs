...
namespace ThePatho.Controllers
{
    ...
    public class NumericalSizeController : ControllerBase
    {
        ...
        public async Task<IActionResult> ExportNumericalSize([FromQuery] string type, CancellationToken cancellationToken)
        {
            var exportResponse = await mediator.Send(new ExportNumericalSizeCommand { Type = type }, cancellationToken);
