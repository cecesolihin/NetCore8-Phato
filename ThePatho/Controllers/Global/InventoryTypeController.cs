...
namespace ThePatho.Controllers
{
    ...
    public class InventoryTypeController : ControllerBase
    {
        ...
        public async Task<IActionResult> ExportInventoryType([FromQuery] string type, CancellationToken cancellationToken)
        {
            var exportResponse = await mediator.Send(new ExportInventoryTypeCommand { Type = type }, cancellationToken);
