...
namespace ThePatho.Controllers
{
    ...
    public class BloodTypeController : ControllerBase
    {
        ...
        public async Task<IActionResult> ExportBloodType([FromQuery] string type, CancellationToken cancellationToken)
        {
            var exportResponse = await mediator.Send(new ExportBloodTypeCommand { Type = type }, cancellationToken);
