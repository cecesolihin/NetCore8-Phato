...
namespace ThePatho.Controllers
{
    ...
    public class InventoryConditionController : ControllerBase
    {
        ...
        public async Task<IActionResult> ExportInventoryCondition([FromQuery] string type, CancellationToken cancellationToken)
        {
            var exportResponse = await mediator.Send(new ExportInventoryConditionCommand { Type = type }, cancellationToken);
