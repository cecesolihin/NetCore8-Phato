...
{
    [ApiController]
    [Route(ApiRoutes.GlobalMenu.Country)]
    ...
    public class CountryController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetCountryList([FromBody] GetCountryCommand command,
        ...
        public async Task<IActionResult> GetCountryByCriteria([FromQuery] GetCountryByCriteriaCommand command,
            CancellationToken cancellationToken)
        {
            var result = await mediator.Send(command, cancellationToken);
            return ApiResult(result);
        ...
        public async Task<IActionResult> GetSingleCountry([FromQuery] GetSingleCountryCommand command,
            CancellationToken cancellationToken)
        {
            var result = await mediator.Send(command, cancellationToken);
            return ApiResult(result);
        ...
        public async Task<IActionResult> SubmitCountry([FromBody] SubmitCountryCommand command,
            CancellationToken cancellationToken)
        {
            var result = await mediator.Send(command, cancellationToken);
            return ApiResult(result);
        ...
        public async Task<IActionResult> ExportCountry([FromQuery] string type, CancellationToken cancellationToken)
        {
            var exportResponse = await mediator.Send(new ExportCountryCommand { Type = type }, cancellationToken);
