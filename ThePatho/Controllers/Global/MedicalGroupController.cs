...
namespace ThePatho.Controllers
{
    ...
    public class MedicalGroupController : ControllerBase
    {
        ...
        public async Task<IActionResult> ExportMedicalGroup([FromQuery] string type, CancellationToken cancellationToken)
        {
            var exportResponse = await mediator.Send(new ExportMedicalGroupCommand { Type = type }, cancellationToken);
