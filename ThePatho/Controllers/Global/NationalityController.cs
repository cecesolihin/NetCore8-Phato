...
namespace ThePatho.Controllers
{
    ...
    public class NationalityController : ControllerBase
    {
        ...
        public async Task<IActionResult> ExportNationality([FromQuery] string type, CancellationToken cancellationToken)
        {
            var exportResponse = await mediator.Send(new ExportNationalityCommand { Type = type }, cancellationToken);
