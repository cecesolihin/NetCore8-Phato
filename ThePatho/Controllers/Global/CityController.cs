...
{
    [ApiController]
    [Route(ApiRoutes.GlobalMenu.City)]
    ...
    public class CityController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetCityList([FromBody] GetCityCommand command,
        ...
        public async Task<IActionResult> GetCityByCriteria([FromQuery] GetCityByCriteriaCommand command,
            CancellationToken cancellationToken)
        {
            var result = await mediator.Send(command, cancellationToken);
            return ApiResult(result);
        ...
        public async Task<IActionResult> GetSingleCity([FromQuery] GetSingleCityCommand command,
            CancellationToken cancellationToken)
        {
            var result = await mediator.Send(command, cancellationToken);
            return ApiResult(result);
        ...
        public async Task<IActionResult> SubmitCity([FromBody] SubmitCityCommand command,
            CancellationToken cancellationToken)
        {
            var result = await mediator.Send(command, cancellationToken);
            return ApiResult(result);
        ...
        public async Task<IActionResult> ExportCity([FromQuery] string type, CancellationToken cancellationToken)
        {
            var exportResponse = await mediator.Send(new ExportCityCommand { Type = type }, cancellationToken);
