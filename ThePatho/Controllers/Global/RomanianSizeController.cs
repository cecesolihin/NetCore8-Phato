...
namespace ThePatho.Controllers
{
    ...
    public class RomanianSizeController : ControllerBase
    {
        ...
        public async Task<IActionResult> ExportRomanianSize([FromQuery] string type, CancellationToken cancellationToken)
        {
            var exportResponse = await mediator.Send(new ExportRomanianSizeCommand { Type = type }, cancellationToken);
