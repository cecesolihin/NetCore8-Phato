...
namespace ThePatho.Controllers
{
    ...
    public class MaritalStatusController : ControllerBase
    {
        ...
        public async Task<IActionResult> ExportMaritalStatus([FromQuery] string type, CancellationToken cancellationToken)
        {
            var exportResponse = await mediator.Send(new ExportMaritalStatusCommand { Type = type }, cancellationToken);
