...
namespace ThePatho.Controllers
{
    ...
    public class AnnouncementController : ControllerBase
    {
        ...
        public async Task<IActionResult> ExportAnnouncement([FromQuery] string type, CancellationToken cancellationToken)
        {
            var exportResponse = await mediator.Send(new ExportAnnouncementCommand { Type = type }, cancellationToken);
