...
namespace ThePatho.Controllers
{
    ...
    public class ReligionController : ControllerBase
    {
        ...
        public async Task<IActionResult> ExportReligion([FromQuery] string type, CancellationToken cancellationToken)
        {
            var exportResponse = await mediator.Send(new ExportReligionCommand { Type = type }, cancellationToken);
