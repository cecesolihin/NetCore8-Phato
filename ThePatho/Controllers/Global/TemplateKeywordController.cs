...
namespace ThePatho.Controllers
{
    ...
    public class TemplateKeywordController : ControllerBase
    {
        ...
        public async Task<IActionResult> ExportTemplateKeyword([FromQuery] string type, CancellationToken cancellationToken)
        {
            var exportResponse = await mediator.Send(new ExportTemplateKeywordCommand { Type = type }, cancellationToken);
