...
namespace ThePatho.Controllers
{
    ...
    public class ShoeSizeController : ControllerBase
    {
        ...
        public async Task<IActionResult> ExportShoeSize([FromQuery] string type, CancellationToken cancellationToken)
        {
            var exportResponse = await mediator.Send(new ExportShoeSizeCommand { Type = type }, cancellationToken);
