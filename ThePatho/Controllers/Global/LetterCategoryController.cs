...
namespace ThePatho.Controllers
{
    ...
    public class LetterCategoryController : ControllerBase
    {
        ...
        public async Task<IActionResult> ExportLetterCategory([FromQuery] string type, CancellationToken cancellationToken)
        {
            var exportResponse = await mediator.Send(new ExportLetterCategoryCommand { Type = type }, cancellationToken);
