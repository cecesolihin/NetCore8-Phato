...
namespace ThePatho.Controllers
{
    ...
    public class PunishmentTypeController : ControllerBase
    {
        ...
        public async Task<IActionResult> ExportPunishmentType([FromQuery] string type, CancellationToken cancellationToken)
        {
            var exportResponse = await mediator.Send(new ExportPunishmentTypeCommand { Type = type }, cancellationToken);
