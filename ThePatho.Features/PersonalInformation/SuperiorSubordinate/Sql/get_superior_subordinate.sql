...
ORDER BY 
    CASE WHEN @SortBy = 'EmployeeName' AND @OrderBy = 'ASC' THEN e.EmployeeName END ASC,
    CASE WHEN @SortBy = 'EmployeeName' AND @OrderBy = 'DESC' THEN e.EmployeeName END DESC,
    CASE WHEN @SortBy = 'EffectiveDate' AND @OrderBy = 'ASC' THEN t.EffectiveDate END ASC,
    CASE WHEN @SortBy = 'EffectiveDate' AND @OrderBy = 'DESC' THEN t.EffectiveDate END DESC
