...
{
    public class GetCareerTypeCommand : IRequest<ApiResponse<CareerTypeItemDto>>
    {
        [JsonPropertyName("filter_CareerTypeName")]
        public string? FilterCareerTypeName { get; set; }
