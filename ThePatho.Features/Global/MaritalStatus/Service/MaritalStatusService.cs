...
namespace ThePatho.Features.Global.MaritalStatus.Service
{
    public class MaritalStatusService : IMaritalStatusService
    {
        ...
        public async Task<ApiResponse<AttachmentFileDto>> ExportAsync(ExportMaritalStatusCommand request)
        {
            try
            {
                var criteriaRequest = new GetMaritalStatusByCriteriaCommand();
                var response = await GetMaritalStatusByCriteria(criteriaRequest);
                var data = response.Data?.MaritalStatusList ?? new System.Collections.Generic.List<MaritalStatusDto>();
                ...
                if (type == "excel" || type == "xlsx")
                {
                    ...
                    var worksheet = workbook.Worksheets.Add("MaritalStatusList");

                    // Title
                    worksheet.Cell("A1").Value = "MaritalStatus List";
                    ...
                    var properties = typeof(MaritalStatusDto).GetProperties();
                    int col = 2;
                    ...
                    var dto = new AttachmentFileDto
                    {
                        ...
                        FileName = "MaritalStatusList.xlsx",
                ...
                else if (type == "pdf")
                {
                    ...
                    {
                        Base64Data = Convert.ToBase64String(bytes),
                        FileName = "MaritalStatusList.pdf",
            ...
            {
                return new ApiResponse<AttachmentFileDto>(System.Net.HttpStatusCode.BadRequest, default, "Gagal export MaritalStatus", ex.Message);
            }
        }
    }
}
