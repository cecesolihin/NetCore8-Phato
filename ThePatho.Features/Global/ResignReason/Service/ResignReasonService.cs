...
namespace ThePatho.Features.Global.ResignReason.Service
{
    public class ResignReasonService : IResignReasonService
    {
        ...
        public ResignReasonService(ApplicationDbContext _context, DapperContext _dappercontext, SqlQueryLoader _queryLoader, IDbConnection _dbConnection, ICurrentUserService _currentUserService)
        {
            context = _context;
        ...
        public async Task<ApiResponse<AttachmentFileDto>> ExportAsync(ExportResignReasonCommand request)
        {
            try
            {
                var criteriaRequest = new GetResignReasonByCriteriaCommand();
                var response = await GetResignReasonByCriteria(criteriaRequest);
                var data = response.Data?.ResignReasonList ?? new System.Collections.Generic.List<ResignReasonDto>();
                ...
                if (type == "excel" || type == "xlsx")
                {
                    ...
                    var worksheet = workbook.Worksheets.Add("ResignReasonList");

                    // Title
                    worksheet.Cell("A1").Value = "ResignReason List";
                    ...
                    var properties = typeof(ResignReasonDto).GetProperties();
                    int col = 2;
                    ...
                    var dto = new AttachmentFileDto
                    {
                        ...
                        FileName = "ResignReasonList.xlsx",
            ...
            {
                return new ApiResponse<AttachmentFileDto>(System.Net.HttpStatusCode.BadRequest, default, "Gagal export ResignReason", ex.Message);
            }
        }
    }
}
