...
namespace ThePatho.Features.Global.InventoryGroup.Service
{
    public class InventoryGroupService : IInventoryGroupService
    {
        ...
        public async Task<ApiResponse<AttachmentFileDto>> ExportAsync(ExportInventoryGroupCommand request)
        {
            try
            {
                var criteriaRequest = new GetInventoryGroupByCriteriaCommand();
                var response = await GetInventoryGroupByCriteria(criteriaRequest);
                var data = response.Data?.InventoryGroupList ?? new System.Collections.Generic.List<InventoryGroupDto>();
                ...
                if (type == "excel" || type == "xlsx")
                {
                    ...
                    var worksheet = workbook.Worksheets.Add("InventoryGroupList");

                    // Title
                    worksheet.Cell("A1").Value = "InventoryGroup List";
                    ...
                    var properties = typeof(InventoryGroupDto).GetProperties();
                    int col = 2;
                    ...
                    var dto = new AttachmentFileDto
                    {
                        ...
                        FileName = "InventoryGroupList.xlsx",
                ...
                else if (type == "pdf")
                {
                    ...
                    {
                        Base64Data = Convert.ToBase64String(bytes),
                        FileName = "InventoryGroupList.pdf",
            ...
            {
                return new ApiResponse<AttachmentFileDto>(System.Net.HttpStatusCode.BadRequest, default, "Gagal export InventoryGroup", ex.Message);
            }
        }
    }
}
