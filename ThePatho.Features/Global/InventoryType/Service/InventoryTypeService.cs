...
namespace ThePatho.Features.Global.InventoryType.Service
{
    public class InventoryTypeService : IInventoryTypeService
    {
        ...
        public async Task<ApiResponse<AttachmentFileDto>> ExportAsync(ExportInventoryTypeCommand request)
        {
            try
            {
                var criteriaRequest = new GetInventoryTypeByCriteriaCommand();
                var response = await GetInventoryTypeByCriteria(criteriaRequest);
                var data = response.Data?.InventoryTypeList ?? new System.Collections.Generic.List<InventoryTypeDto>();
                ...
                if (type == "excel" || type == "xlsx")
                {
                    ...
                    var worksheet = workbook.Worksheets.Add("InventoryTypeList");

                    // Title
                    worksheet.Cell("A1").Value = "InventoryType List";
                    ...
                    var properties = typeof(InventoryTypeDto).GetProperties();
                    int col = 2;
                    ...
                    var dto = new AttachmentFileDto
                    {
                        ...
                        FileName = "InventoryTypeList.xlsx",
                ...
                else if (type == "pdf")
                {
                    ...
                    {
                        Base64Data = Convert.ToBase64String(bytes),
                        FileName = "InventoryTypeList.pdf",
            ...
            {
                return new ApiResponse<AttachmentFileDto>(System.Net.HttpStatusCode.BadRequest, default, "Gagal export InventoryType", ex.Message);
            }
        }
    }
}
