...
{
    public class GetGroupByCriteriaCommandHandler : IRequestHandler<GetGroupByCriteriaCommand, ApiResponse<GroupItemDto>>
    {
        ...
        public async Task<ApiResponse<GroupItemDto>> Handle(GetGroupByCriteriaCommand request, CancellationToken cancellationToken)
        {
