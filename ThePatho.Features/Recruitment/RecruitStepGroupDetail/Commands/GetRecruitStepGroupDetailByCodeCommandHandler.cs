...
{
    public class GetRecruitStepGroupDetailByCodeCommandHandler : IRequestHandler<GetRecruitStepGroupDetailByCodeCommand, RecruitStepGroupDetailItemDto>
    {
        private readonly IRecruitStepGroupDetailService recruitStepGroupDetailService;
        public GetRecruitStepGroupDetailByCodeCommandHandler(IRecruitStepGroupDetailService _recruitStepGroupDetailService)
        {
