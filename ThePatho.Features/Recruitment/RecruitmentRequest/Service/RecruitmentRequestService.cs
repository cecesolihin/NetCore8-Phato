...
namespace ThePatho.Features.Recruitment.RecruitmentRequest.Service
{
    public class RecruitmentRequestService : IRecruitmentRequestService
    {
        ...
        public async Task<NewApiResponse<RecruitmentRequestItemDto>> GetRecruitmentRequest(GetRecruitmentRequestCommand request)
        {
            try
            {
                ...
                var data = await db.GetAsync<RecruitmentRequestDto>(query);
                var result = new RecruitmentRequestItemDto
                {
                    DataOfRecords = data.ToList().Count,
                    RecruitmentRequestList = data.ToList(),
                };
                return new NewApiResponse<RecruitmentRequestItemDto>(HttpStatusCode.OK, result);
            }
            catch (Exception ex)
            {

                return new NewApiResponse<RecruitmentRequestItemDto>(
        ...
        public async Task<NewApiResponse<RecruitmentRequestDto>> GetRecruitmentRequestByCriteria(GetRecruitmentRequestByCriteriaCommand request)
        {
            try
            {
                using var connection = dapperContext.CreateConnection();
                ...
                return new NewApiResponse<RecruitmentRequestDto>(HttpStatusCode.OK, data);
            }
            catch (Exception ex)
            {

                return new NewApiResponse<RecruitmentRequestDto>(
                        HttpStatusCode.BadRequest,
                        "An error occurred while retrieving data.",
                        ex.Message
                    );
        ...
        public async Task<ApiResponse> SubmitRecruitmentRequest(SubmitRecruitmentRequestCommand request)
        {
            ...
            try
            {
                ...
                transaction.Commit();
                return new ApiResponse(HttpStatusCode.OK, $"{request.Action} {request.RequestNo} successfully");
            }
            catch(Exception ex)
            {
                transaction.Rollback();
                return new ApiResponse(HttpStatusCode.BadRequest, $"Failed to {request.Action} {request.RequestNo}", ex.Message.ToString());
            }
        }

        public async Task<ApiResponse> DeleteRecruitmentRequest(DeleteRecruitmentRequestCommand request)
        {
            using var connection = dapperContext.CreateConnection();
            var db = new QueryFactory(connection, dapperContext.Compiler);
            ...
            try
            {
              ...
              .AsDelete();
                ...
                return new ApiResponse(HttpStatusCode.OK, $"Delete {request.RequestNo} successfully");
            }
            catch (Exception ex)
            {
                return new ApiResponse(HttpStatusCode.BadRequest, $"Failed to delete {request.RequestNo}", ex.Message.ToString());
            }
        }
    }
}
