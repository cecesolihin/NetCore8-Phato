...
{
    public class GetRecruitmentReqStepByCriteriaCommandHandler : IRequestHandler<GetRecruitmentReqStepByCriteriaCommand, ApiResponse<RecruitmentReqStepItemDto>>
    {
        ...
        public async Task<ApiResponse<RecruitmentReqStepItemDto>> Handle(GetRecruitmentReqStepByCriteriaCommand request, CancellationToken cancellationToken)
        {
